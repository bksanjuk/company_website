      ...
      <div className="container mx-auto px-4 max-w-6xl">
        ...
        <div className="grid md:grid-cols-3 gap-6 mb-20">
          {[
            ...
            >
              <h3 className="text-xl font-bold mb-2">{item.tile}</h3>
        ...
        <div className="mb-12 max-w-4xl mx-auto">
          <div className="bg-white shadow rounded-xl overflow-hidden">
            <iframe
              src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3162.190258743619!2d126.97428697714572!3d37.574137323690195!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x357ca2eb421c44ad%3A0xe955a50c118085f8!2z6rSR7ZmU66y46rSR7J6l!5e0!3m2!1sko!2skr!4v1748419273937!5m2!1sko!2skr"
              width="100%"
              height="400"
              allowfullscreen=""
              loading="lazy"
